...
registerResourceModule({
  ...
  description:
    'Latest dotnet_target_framework_check: per-project target framework moniker + EOL/legacy status.',
...
registerResourceModule({
  ...
  description:
    'Latest dotnet_efcore_audit: dangerous migration patterns detected (DropTable, DropColumn, ' +
