...
export const jscpdParser: ScannerParser = {
...
function mapDuplicate(raw: unknown, ctx: ParserContext): Finding | null {
  ...
  if (firstStart !== undefined) input.line_start = firstStart;
  if (firstEnd !== undefined) input.line_end = firstEnd;
