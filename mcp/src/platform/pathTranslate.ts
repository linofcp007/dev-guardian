...
export interface ShellChoiceLike {
 ...
 */
export function toWsl(input: string): string {
  ...
  if (driveRaw === undefined || restRaw === undefined) return input;
 ...
 */
export function fromWsl(input: string): string {
 ...
 */
export function toShellPath(input: string, shell: ShellChoiceLike): string {
