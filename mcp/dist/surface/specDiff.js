 ...
 */
function methodsMatch(codeMethod, specMethod) {
...
function displayMethod(codeMethod, specMethod) {
...
export function diffSpecRoutes(codeRoutes, specRoutes, specsParsed) {
    ...
    for (const c of codeResolvable) {
        ...
        for (const s of candidates) {
            if (!methodsMatch(c.method, s.method))
                continue;
