 ...
 */
export const YARA_SIGNATURES = [
    {
        id: 'sig-exfil-host',
        category: 'data_exfiltration',
        severity: 'high',
        title: 'Known exfiltration / drop host',
        description: 'References a host commonly used to receive exfiltrated data or out-of-band callbacks.',
        strings: [
    ...
    },
    {
        ...
        description: 'Hardcoded crypto wallet address combined with clipboard access — typical address-swap malware.',
        strings: [
    ...
    },
    {
        ...
        description: 'A long contiguous base64 string — often an embedded binary or obfuscated payload. Inspect manually.',
...
export function matchSignatures(content) {
    const out = [];
...
//# sourceMappingURL=yaraSignatures.js.map