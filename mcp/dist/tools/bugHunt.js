...
registerToolModule(makeScanTool({
    name: 'bug_hunt',
    title: 'Bug hunt (Semgrep r2c-bug-scan + security-audit + stack-detected language packs; ' +
        'bug classes still Python-strong, JS/TS-thin)',
    description: 'Semgrep with p/r2c-bug-scan + p/security-audit, plus a per-language pack added ' +
