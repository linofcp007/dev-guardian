...
- [x] **Step 1: Write `mcp/src/dast/types.ts`**
...
- [x] **Step 2: Write the failing test for target classification**
...
- [x] **Step 4: Implement `mcp/src/dast/target.ts`**
...
- [x] **Step 6: Extend the persisted unions in `mcp/src/types.ts`**
...
- [x] **Step 1: Export `PARAM_SYNTAX` from `specDiff.ts`**
...
- [x] **Step 4: Implement `mcp/src/dast/plan.ts`**
...
- [x] **Step 6: Run the whole suite, build, commit**
...
- [x] **Step 3: Implement `mcp/src/dast/probe.ts`**
...
- [x] **Step 5: Run the suite, build, commit**
...
- [x] **Step 3: Implement `analyzeRoutes` in `mcp/src/dast/analyze.ts`**
...
7. Fingerprints come from `computeFingerprint` with
   `tool: 'dast'`, a `rule_id` built as `${check}:${method}:${path}`, `file_path`,
...
- [x] **Step 3: Implement `analyzeOrigin`**
...
- [x] **Step 3: Implement `mcp/src/dast/rateLimit.ts`**
...
- [x] **Step 1: Write the failing test for argument construction**
...
- [x] **Step 2: Write the failing test for JSONL normalisation**
...
- [x] **Step 3: Run both to verify they fail.** Expected: modules not found.

- [x] **Step 4: Implement both modules**
...
- [x] **Step 5: Add the nuclei entry to `installCatalog.ts`**
...
- [x] **Step 6: Run to verify both pass, then the suite, build, commit**
...
- [x] **Step 2: Run to verify it fails.** Expected: `scan_dast` is not registered.

- [x] **Step 3: Implement `mcp/src/tools/scanDast.ts`**
...
- [x] **Step 4: Run to verify it passes.** Then `npm test`, `npm run build`.
...
- [x] **Step 1: Write the fixture app**
...
- [x] **Step 3: Run, verify, build, commit**
...
- [x] **Step 1: Count the tools and update every place the count appears**
...
- [x] **Step 3: Verify markdownlint stays clean**
